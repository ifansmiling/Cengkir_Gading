    ...
    <UserLayout>
      <div className="bg-white min-h-screen py-12 px-6">
        <div className="container mx-auto">
          <h1 className="font-dramatic-header text-3xl font-extrabold text-left text-green-800 mb-12 border-b-2 border-green-800 inline-block">
            Daftar Skenario Drama
          </h1>
          ...
          <div className="ml-10 mr-10 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {skenarioList.map((skenario) => (
              <div
                key={skenario.id}
                className="border border-gray-300 shadow-sm hover:shadow-md rounded-lg overflow-hidden transition-all duration-300 hover:border-green-500"
              >
                <div className="p-6 flex flex-col h-full justify-between">
                  <div>
                    ...
                    <p className="text-gray-500 mb-6 text-justify font-event-body">
                      {skenario.deskripsi}
                    </p>
                  </div>
                  <a
                    ...
                    download
                    className="font-event-body inline-block bg-gradient-to-r from-blue-500 to-green-500 text-white text-center w-full py-2 rounded-lg shadow-sm hover:from-blue-600 hover:to-green-600 transition-all duration-300"
                  >
                    Unduh{" "}
